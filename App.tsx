  ...
  return(
    <Tab.Navigator initialRouteName="Home" screenOptions={
      ...
      <Tab.Screen name = "Home" component={Home} options={{headerShown: false, tabBarIcon:() => (
        <Icon name="home" color ="#150230" size={24} />
      )}}/>
      <Tab.Screen name="Profile" component={Profile} options={{headerShown: false, tabBarIcon:() => (
        <Icon name="account" color ="#150230" size={24} />
        )}}/>
      <Tab.Screen name="Recharges" component={Recharges} options={{headerShown: false, tabBarIcon:() => (
        <Icon name="cellphone" color ="#150230" size={24} />
        )}}/>
    </Tab.Navigator>
  )
}
